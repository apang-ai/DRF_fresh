...
from freshshop.settings import ali_pub_key_path, private_key_path
...
class OrderDetailSerializer(serializers.ModelSerializer):
    ...
    def get_alipay_url(self, obj):
        alipay = AliPay(
            appid="2016101700710170",
            app_notify_url="http://182.92.180.149:80/alipay/return/",
            app_private_key_path=private_key_path,
            alipay_public_key_path=ali_pub_key_path,  # 支付宝的公钥，验证支付宝回传消息使用，不是你自己的公钥,
            debug=True,  # 默认False,
            return_url="http://182.92.180.149:80/alipay/return/"
        )
